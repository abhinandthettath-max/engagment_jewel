...
const invitation = {
  groom: "Joseph Fexin Faber",
  bride: "Annie George",
  shortGroom: "Fexin",
  shortBride: "Annie",
  eventName: "Engagement",
  dateParts: ["06", "06", "2026"],
  weekday: "Saturday",
  countdownTarget: "2026-06-06T12:00:00+05:30",
  ...
  parents: {
    groom: "Mr. Francis Faber & Late Mrs. Treesa Faber",
    bride: "Mr. George Marson & Mrs. Zeema Mary",
  },
};
...
const events = [
  {
    ...
    time: "12:00 PM",
    venue: "St. Francis Assisi Church, Vellapally Alappuzha, Kerala",
    modalVenue: "St. Francis Assisi Church, Vellapally Alappuzha",
    region: "Kerala, India",
    map: "https://maps.app.goo.gl/1K393dWUBo7MB2nU9",
  },
  {
    ...
    time: "11:00 AM",
    venue: "Carmel hill monastery Roman Catholic church, vazhuthacaud",
    note: "Followed by reception at Mount Carmel convention centre",
    modalVenue: "Carmel hill monastery Roman Catholic church, vazhuthacaud",
    region: "Mount Carmel convention centre",
    map: "https://maps.app.goo.gl/JsSnoz2DmsJyWRHW6",
  },
];
  ...
  return (
    <section className="couple-section">
      ...
      <div className="couple-photo-frame" data-reveal>
        <img src={invitation.coupleImage} alt="Fexin & Annie" />
      </div>
        ...
        <div className="sheet-locations">
          {events.map((event) => (
            <article className="sheet-location" key={event.title}>
              <div>
                <h4>{event.title === "Engagement Ceremony" ? "The Engagement Ceremony" : event.title}</h4>
                <p>
